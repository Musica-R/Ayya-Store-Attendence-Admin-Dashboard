...
const RaiseTicket = () => {
    ...
    const fetchRaiseTicket = async () => {
      try {
        const response = await fetch(
          `https://store.mpdatahub.com/api/tickets?month=${dateFilter.month}&year=${dateFilter.year}`
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        'https://store.mpdatahub.com/api/ticket/create',
        {
          method: 'POST',
          body: submitData,
        }
  ...
  const handleStatusUpdate = async (id, status) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://store.mpdatahub.com/api/ticket/status`,
        {
          method: 'POST',
          headers: {
  ...
  const handleDelete = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://store.mpdatahub.com/api/delete-Holida/${deleteId}`
      );
  ...
  const handleNotification = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://store.mpdatahub.com/api/notification/send`,
        {
          method: 'POST',
          body: submitData,
        }
