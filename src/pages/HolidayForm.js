...
const HolidayForm = () => {
    ...
    const fetchHolidays = async () => {
      try {
        const response = await fetch(
          `https://store.mpdatahub.com/api/holiday/list?month=${dateFilter.month}&year=${dateFilter.year}`
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        'https://store.mpdatahub.com/api/holiday/create',
        {
          method: 'POST',
          body: submitData,
        }
  ...
  const handleDelete = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://store.mpdatahub.com/api/delete-Holiday/${deleteId}`
      );
  ...
  const handleNotification = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://store.mpdatahub.com/api/send-holiday-notification`,
        {
          method: 'POST',
          body: submitData,
        }
